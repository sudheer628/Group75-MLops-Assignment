    ...
    try:
        ...
        if experiment:
            ...
            experiment_id = mlflow.create_experiment(
                ...
                tags={"description": description or "Heart Disease Prediction Experiment"}
            )
...
def log_feature_engineering_info(X_original, X_engineered, experiment_id):
    ...
    with mlflow.start_run(run_name="feature_engineering") as run:
        ...
        mlflow.log_param("techniques_used", [
            "age_grouping", "ratio_features", "interaction_features", 
            "derived_features", "robust_scaling"
        ])
...
def train_and_log_model(model_name, model, X_train, X_test, y_train, y_test, 
                       cv_scores=None, hyperparameters=None):
    """
...
def run_experiment_comparison(experiment_name="heart_disease_comparison"):
    ...
    experiment_id = create_experiment(experiment_name, 
                                    "Comprehensive heart disease prediction model comparison")
    ...
    try:
        ...
        for model_name, config in models_config.items():
            ...
            cv_scores = cross_val_score(config['model'], X_train, y_train, 
